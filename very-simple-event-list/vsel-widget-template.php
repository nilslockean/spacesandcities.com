			...
			if ($widget_image_hide != 'yes') {
				if ( has_post_thumbnail() ) {
					...
					if ($widget_link_image != 'yes') {
						$output .= '<img class ="'.$widget_img_class.'" src="'.$image_attributes[0].'" width="'.$image_attributes[1].'" height="'.$image_attributes[2].'" />';
					} else {
						$output .=  '<a href="'. get_permalink() .'"><img class ="'.$widget_img_class.'" src="'.$image_attributes[0].'" width="'.$image_attributes[1].'" height="'.$image_attributes[2].'" /></a>';
					}
				}
			}
			// info
